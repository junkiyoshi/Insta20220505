...
void ofApp::setup() {
	...
	// 配色デザイン グレイ P.240
	this->color_palette.push_back(ofColor(158, 158, 159));
	this->color_palette.push_back(ofColor(199, 198, 199));
	this->color_palette.push_back(ofColor(228, 227, 226));
	//this->color_palette.push_back(ofColor(113, 112, 115));
	this->color_palette.push_back(ofColor(184, 171, 150));
	this->color_palette.push_back(ofColor(128, 137, 105));
	this->color_palette.push_back(ofColor(192, 143, 87));
	this->color_palette.push_back(ofColor(76, 74, 74));

	ofBackground(ofColor(113, 112, 115));
